...
export const getMesasById = async (req, res) => {
    ...
    const pool = await getConnection();
    const result = await pool.request().input("id_mesa", id_mesa).query(queries.getMesasById);
...
export const deleteMesasById = async (req, res) =>{
    ...
    const pool = await getConnection();
    const result = await pool.request().input("id_mesa", id_mesa).query(queries.deleteMesasById);
...
export const getTotalMesas = async (req, res) => {
    const pool = await getConnection(); 
    const result = await pool.request().query(queries.getTotalMesas);
